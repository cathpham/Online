...
new_X_array = new_X.to_numpy()
new_X_scaled = scaler.transform(new_X_array)

# Predict button
if st.button("Predict"):
    # Make predictions with each model
    log_gb = gb.predict(new_X_scaled)
    log_xgb = xgb_model.predict(new_X_scaled)
    log_lgb = lgb_model.predict(new_X_scaled)
